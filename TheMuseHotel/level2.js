...
class level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.ghost = this.physics.add.sprite(327, 128, 'ghost');
        this.ghost2 = this.physics.add.sprite(160, 327, 'ghost');
        this.ghost3 = this.physics.add.sprite(562, 435, 'ghost');
        this.ghost4 = this.physics.add.sprite(843, 456, 'ghost');
        this.ghost5 = this.physics.add.sprite(618, 128, 'ghost');
        this.garbage = this.physics.add.sprite(384, 149, 'garbage');
        this.garbage2 = this.physics.add.sprite(928, 474, 'garbage');
        this.garbage3 = this.physics.add.sprite(736, 541, 'garbage');
        this.garbage4 = this.physics.add.sprite(762, 217, 'garbage');
        ...
        this.itemlayer.setCollisionByProperty({ Bookshelves: true });
        this.itemlayer.setCollisionByProperty({ Scarydolls: true });
        this.itemlayer.setCollisionByProperty({ Smalltable: true });
        ...
        this.itemlayer.setCollisionByProperty({ Plumber: true });
        this.itemlayer.setCollisionByProperty({ Washingmachine: true });
        this.itemlayer.setCollisionByProperty({ Bath: true });
        this.itemlayer2.setCollisionByProperty({ Showerhead: true });
        this.walllayer.setCollisionByProperty({ Walltoilet: true });
        ...
        this.itemlayer2.setCollisionByProperty({ Sidetablelamp: true });
        this.itemlayer.setCollisionByProperty({ Pumpkins: true });
        this.itemlayer.setCollisionByProperty({ Fireplace: true });
        this.itemlayer.setCollisionByProperty({ Brain: true });
        ...
        this.physics.add.overlap(
            this.player,
            [this.garbage, this.garbage2, this.garbage3, this.garbage4],
            this.collectGarbage,
            null,
            this
        );
